...
public class ControlPanel extends JPanel {
    ...
    public void setMazeSizeListener(final MazeShowPanel p) {
        ...
        SelectList.addListSelectionListener(e -> select = SelectList.getSelectedIndex());

        showSelect.addActionListener(e -> p.setMazeSize(saveVector.get(select)));


        maze_cls.addActionListener(e -> p.setMazeSize(MazePaintPanel.NONE));
    }

    public void setRunListener(final MazeShowPanel p) {
        runByCom.addActionListener(e -> p.computerRun());
    }
